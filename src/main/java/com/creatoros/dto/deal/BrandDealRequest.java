...
/**
 * Create/update payload for a brand deal. {@code dealNumber} is deliberately absent - the server
 * owns that sequence.
 */
public record BrandDealRequest(
        ...
        // Blank is allowed: the contact may not be known when a lead is first logged.
