 ...
 *
 * <p>Creator identity and payout details are snapshotted onto the row at issue time rather than
 * joined from {@link Creator}: a tax document must keep showing the details that were valid when
 * it was raised, even if the profile changes later.
 */
@Entity
@Table(name = "invoice")
@Getter
...
public class Invoice {
    ...
    /** True places the supply outside the creator's state, so IGST applies instead of CGST+SGST. */
